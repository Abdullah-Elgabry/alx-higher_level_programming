...
class TestRectangle(unittest.TestCase):
    '''Testing the functionality of the Rectangle class.'''
...
given"
    ...
    def test_I_area(self):
        '''checks the def func methedology'''
        r = Rectangle(5, 6)
